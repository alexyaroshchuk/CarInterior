                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row sweetalert justify-content-center">
                                            <div>
                                                <button class="edit-arrival" data-toggle="modal" data-target="#edit-arrival{{$c['employee_id']}}" title="Edit" type="button" style="border: 0; background:0">
                                                    <span class="material-icons">&#xe8ff;</span>
                                                </button>
                                            </div>
                                            <div>
                                                <form method="POST"
                                                      action="{{route('employee.delete', ['employee' => $c['employee_id']])}}"> @csrf
                                                    <button title="Delete" data-toggle="tooltip" type="submit" name = "employee" id="employee" style="border: 0; background:0">
                                                        <span class="material-icons">&#xe92b;</span>
                                                    </button>
                                                </form>
                                            </div>
