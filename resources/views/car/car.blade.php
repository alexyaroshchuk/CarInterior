                        ...
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            @foreach($car as $index => $c)
                                <tr>
                                    ...
                                    <td>{{ $c->mark }}</td>
                                    <td>{{ $c->model }}</td>
                                    <td>{{ $c->provider['0']->full_name_of_provider }}</td>
                                    <td>{{ $c->year_of_issue }}</td>
                                    <td>
                                        <div class="row sweetalert justify-content-center">
                                            <div>
                                                <button class="edit-arrival" data-toggle="modal" data-target="#edit-arrival{{$c['car_id']}}" title="Edit" type="button" style="border: 0; background:0">
                                                    <span class="material-icons">&#xe8ff;</span>
                                                </button>
                                            </div>
                                            <div>
                                                <form method="POST"
                                                      action="{{route('car.delete', ['car' => $c['car_id']])}}"> @csrf
                                                    <button title="Delete" data-toggle="tooltip" type="submit" name = "car" id="car" style="border: 0; background:0">
                                                        <span class="material-icons">&#xe92b;</span>
                                                    </button>
                                                </form>
                                            </div>
